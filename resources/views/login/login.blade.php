		...
		<div class="login-form padding20 fg-white ">
			...
			<form  action="" method="POST">
				...
				<div>
					...
					<a href="{!! URL::to('register')!!}" tppabs="http://scriptunited.com/demo/metroskin/laravel/user/form/signup2" class="fg-white" type="fg-white "><span class="fa fa-sign-in"></span> <u>Đăng ký ngay</u></a>
				</div>
			</form>
		</div>
