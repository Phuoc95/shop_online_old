		...
		<div class="login-form padding20 fg-white ">
			<form  action="" method="POST">
				...
				<div class="input-control password full-size" data-role="input">
					...
					<input type="password" name="RePass" id="user_repassword">
					<button class="button helper-button reveal"><span class="mif-looks"></span></button>
				</div>
				<br />
				<br />
				...
				<div>
					<p>Đã có tài khoản ?</p>
					<a href="{!!URL::to('/login')!!}" tppabs="http://scriptunited.com/demo/metroskin/laravel/user/form/login2" class="fg-white" type="fg-white "><span class="fa fa-sign-in"></span> <u>Đăng nhập tại đây</u></a>
				</div>
			</form>
		</div>
