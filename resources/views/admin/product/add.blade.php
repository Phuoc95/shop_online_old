...
<div class="grid" >
 <form action="{!! route('admin.product.getAdd') !!}" method="POST" enctype="multipart/form-data">
   ...
   <h1 class="text-light align-left" style="margin-bottom:30px;position: relative;left: 8%">Thêm Sản phẩm</h1>  
   <br />
...
<div class="row cells12">
 <div class="cell colspan11 offset1">
   ...
   <button type="button" id="addImages" class="button primary" style="margin:5px -2px;min-width: 110px">
    Thêm ảnh</button>
...
<div ></div>
<div class="row cells12" >
  <div class="cell colspan9 offset1" style="max-height: 100px" >
    <div class="input-control text full-size text info custom_ip2" data-role="input">
      <label for="" >Mô tả::</label>
      <textarea name="txtDescription" rows="3" style="max-height: 100px" >
      </textarea> 
